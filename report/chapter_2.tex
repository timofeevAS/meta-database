...
pagecommand={%
	...
	\begin{turn}{90}%
		\centering
		{Рисунок~\thefigure\ --- Рассмотрение заявки на турнир}\label{fig:schema-image}%
	\end{turn}%
...
\section{Запросы к \texttt{information schema}}
...
\subsection*{Чтение метаданных}
Модуль \smallcode{core/reader-service} используются для чтения метаданных из локальной базы данных метаданных. Выходные данные ожидаются представление "один ко дному" данных на уровне программы.

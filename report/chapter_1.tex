...
\subsection*{Функциональная схема взаимодействия компонент}
На \hyperref[fig:functional-schema]{Рисунке \ref*{fig:functional-schema}} представлена функциональная схема взаимодействия объектов.
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{functional-schema.drawio.pdf}
	\caption{Схема функционального взаимодействия компонент}
	\label{fig:functional-schema}
\end{figure}
...
\subsection*{Прикладная схема сетевого взаимодействия}

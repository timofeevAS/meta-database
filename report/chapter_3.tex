...
\end{enumerate}
Также для генератора запроса выдвинуты дополнительные требования:
\begin{itemize}
	\item наполнение данных в форме при генерация если выбрать таблицу или колонку синхронизируется.
